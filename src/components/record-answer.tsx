...
export const RecordAnswer = ({
  ...
  const recordUserAnswer = async () => {
    try {
      if (isRecording) {
        ...
        // Generate AI result after stopping the recording
        try {
          ...
          toast.error("Error", {
            description: "Failed to generate AI result. Please try again.",
          });
        }
      } else {
        startSpeechToText();
      ...
      toast.error("Error", {
        description: "An error occurred while starting/stopping the recording.",
      });
    }
  };
  ...
  const saveUserAnswer = async () => {
    ...
    if (!aiResult) {
      toast.error("Error", {
        description: "AI result is not available. Please try again.",
      });
      setLoading(false);
      return;
    }
